        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Workers Attendance</h3>
			  <div class="box-tools">
                <ul class="pagination pagination-sm no-margin pull-right">
                  <li><button class="btn btn-info btn-sm"><i class="fa fa-print"></i></button></li>
                </ul>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
				...
				<td><?php echo $que["id"]; ?>
				  ...
				  <td><?php
				  $url = "http://maps.googleapis.com/maps/api/geocode/json?latlng=".$que["latitude"].",".$que["longitude"]."&sensor=true";
				...
				if(is_array($jsondata) && $jsondata['status'] == "OK")
				{
					...
					echo $street;echo ",";echo $city;echo ",";echo $country;
				}
				?>
				</td>
				  <td>
				  <center>
					...
					<a href='maptest.php?lat=<?php echo $que["latitude"]; ?>&lon=<?php echo $que["longitude"]; ?>'>map</a>
					</center>
                </tr>
				<?php } ?>
                </tfoot>
